...
func TestOutreachGenerate_ContactNotFound(t *testing.T) {
	h := &outreachhttp.OutreachHandler{Outreach: &fakeOutreachProvider{err: outreach.ErrContactNotFound}}
	r := testutil.SetupRouter(h.Mount)
...
func TestOutreachGenerate_ContactRequired(t *testing.T) {
	h := &outreachhttp.OutreachHandler{Outreach: &fakeOutreachProvider{err: outreach.ErrContactRequired}}
	r := testutil.SetupRouter(h.Mount)
...
func TestOutreachTones(t *testing.T) {
	...
	h := &outreachhttp.OutreachHandler{Outreach: &fakeOutreachProvider{tones: tones}}
	r := testutil.SetupRouter(h.Mount)
