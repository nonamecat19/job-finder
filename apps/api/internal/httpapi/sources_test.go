...
func TestSourcesList(t *testing.T) {
	...
	h := &httpapi.SourcesHandler{Sources: fake, Enrichment: &fakeEnrichmentRunner{}, Ingestion: &fakeSourceRunner{}}
...
func TestSourcesTest(t *testing.T) {
	h := &httpapi.SourcesHandler{Sources: &fakeSourcesProvider{}, Enrichment: &fakeEnrichmentRunner{}, Ingestion: &fakeSourceRunner{}}
	r := testutil.SetupRouter(h.Mount)
