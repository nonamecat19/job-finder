...
const (
	...
	uuidJob26   = "b0000000-0000-0000-0000-000000000026"
...
var jobs = []jobSeed{
	...
	{
		UUID: uuidJob13, SourceKey: "indeed", Title: "Backend Engineer (Python)",
		Company: "FinEdge", Location: "New York, NY", Remote: false,
		SalaryRaw: "$110k–$140k/yr", URL: "https://indeed.com/viewjob?jk=finedge-backend-engineer",
	...
	{
		UUID: uuidJob14, SourceKey: "indeed", Title: "Site Reliability Engineer",
	...
	{
		UUID: uuidJob15, SourceKey: "glassdoor", Title: "Machine Learning Engineer",
	...
	{
		UUID: uuidJob26, SourceKey: "jobgether", Title: "Senior Backend Engineer (Go)",
