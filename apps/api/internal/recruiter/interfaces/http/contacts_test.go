...
func TestContactsList_Empty(t *testing.T) {
	h := &recruiterhttp.ContactsHandler{Recruiter: &fakeContactsProvider{list: []dto.JobContactDto{}}}
...
func TestContactsList_Populated(t *testing.T) {
	title := "Recruiter"
	h := &recruiterhttp.ContactsHandler{Recruiter: &fakeContactsProvider{
...
func TestContactsList_Error(t *testing.T) {
	h := &recruiterhttp.ContactsHandler{Recruiter: &fakeContactsProvider{listErr: testutil.ErrFake}}
	r := testutil.SetupRouter(h.Mount)
...
func TestContactsRefresh_Error(t *testing.T) {
	h := &recruiterhttp.ContactsHandler{Recruiter: &fakeContactsProvider{refreshErr: testutil.ErrFake}}
	r := testutil.SetupRouter(h.Mount)
