...
func TestEnrichIndeed_Success(t *testing.T) {
	...
	h := enrichment.NewHandler(repo, nil, adapters.DjinniAdapter{}, adapters.DouAdapter{}, adapters.WorkUaAdapter{},
		adapters.IndeedAdapter{Scraping: scraping.New()}, adapters.RemoteOKAdapter{}, adapters.GlassdoorAdapter{}, adapters.JobLeadsAdapter{}, adapters.JobgetherAdapter{}, &enrichFakeEnqueuer{}, 0, nil)
...
func TestEnrichRemoteOK_Success(t *testing.T) {
	...
	h := enrichment.NewHandler(repo, nil, adapters.DjinniAdapter{}, adapters.DouAdapter{}, adapters.WorkUaAdapter{},
		adapters.IndeedAdapter{}, adapters.RemoteOKAdapter{Scraping: scraping.New(), APIURL: srv.URL}, adapters.GlassdoorAdapter{}, adapters.JobLeadsAdapter{}, adapters.JobgetherAdapter{}, &enrichFakeEnqueuer{}, 0, nil)
...
func TestEnrichJobLeads_Success(t *testing.T) {
	...
	h := enrichment.NewHandler(repo, nil, adapters.DjinniAdapter{}, adapters.DouAdapter{}, adapters.WorkUaAdapter{},
		...
		adapters.JobLeadsAdapter{Scraping: scraping.New(), Session: &enrichJobLeadsFakeSession{cookie: "cookie-xyz"}}, adapters.JobgetherAdapter{}, &enrichFakeEnqueuer{}, 0, nil)
