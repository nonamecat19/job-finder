...
func TestCoachAssessPost(t *testing.T) {
	h := &coachhttp.CoachHandler{Coach: &fakeCoachProvider{resp: sampleAssessment()}}
...
func TestCoachAssessPost_NoDiff(t *testing.T) {
	h := &coachhttp.CoachHandler{Coach: &fakeCoachProvider{assessErr: application.ErrNoDiff}}
	r := testutil.SetupRouter(h.Mount)
...
func TestCoachAssessmentGet_NotAssessed(t *testing.T) {
	h := &coachhttp.CoachHandler{Coach: &fakeCoachProvider{cachedErr: application.ErrNotAssessed}}
	r := testutil.SetupRouter(h.Mount)
