...
// Model is a curated free-tier chat model the operator may select in
...
// DefaultModel is used whenever a task's persisted model is empty.
const DefaultModel = "gpt-oss-120b"

// Models is the curated free-tier model list surfaced to the dashboard.
// Exactly one entry MUST have IsDefault set.
var Models = []Model{
...
// IsSupportedModel reports whether id is a known curated model, or empty
