...
func TestCompaniesIntel_NoData(t *testing.T) {
	h := &companyintelhttp.CompaniesHandler{CompanyIntel: &fakeCompanyIntelProvider{}}
...
func TestCompaniesIntel_Error(t *testing.T) {
	h := &companyintelhttp.CompaniesHandler{CompanyIntel: &fakeCompanyIntelProvider{intelErr: testutil.ErrFake}}
	r := testutil.SetupRouter(h.Mount)
...
func TestCompaniesRefresh_NoCompany(t *testing.T) {
	h := &companyintelhttp.CompaniesHandler{CompanyIntel: &fakeCompanyIntelProvider{refreshErr: application.ErrNoCompany}}
	r := testutil.SetupRouter(h.Mount)
