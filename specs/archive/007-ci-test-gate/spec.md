> **ARCHIVED — SUPERSEDED by 023-workflow-quality-gates.**
>
...
>
> **FR-008 (do not add golangci-lint or ESLint gating) is void — 023 authored both configs and made them gating. FR-005 (CI must provision Postgres/Redis) was also revised.**
