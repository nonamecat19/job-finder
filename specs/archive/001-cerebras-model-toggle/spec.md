> **ARCHIVED — SUPERSEDED by 030-litellm-model-routing.**
>
...
>
> **Every requirement in this spec is void. Per-task provider/model selection was removed from the dashboard, the API and the database by feature 030.**
