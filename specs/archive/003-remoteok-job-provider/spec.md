...
>
> **The RemoteOK adapter is wired for enrichment only and is absent from the ingest registry — FR-001/002/005/006 are not currently met. See the drift note in the domain doc.**
